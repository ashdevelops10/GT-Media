    ...
    <main className="relative min-h-screen bg-onyx text-white">
      ...
      <Section>
        <Container size="narrow">
          <div className="text-center border border-silver/20 p-12 md:p-16">
            ...
            <a
              href="/contact"
              className="inline-block px-8 py-4 bg-strawberry text-onyx font-medium hover:bg-opacity-90 transition-all duration-300"
            >
