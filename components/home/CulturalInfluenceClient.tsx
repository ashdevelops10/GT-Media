...
export function CulturalInfluenceClient({ photos }: Props) {
 ...
 <div
 className="flex gap-6 whitespace-nowrap hover:[animation-play-state:paused]" style={{
 width:"fit-content",
 ...
 <div
 key={`${photo.src}-${index}`}
 className={`relative flex-shrink-0 overflow-hidden bg-neutral-900 border border-white/5 group ${photo.orientation ==="portrait" ?"w-[180px] md:w-[240px] aspect-[3/4]" :"w-[240px] md:w-[360px] aspect-[4/3]" }`}
 >
 <img
 src={photo.src}
 alt="Celebrity collaboration" loading="lazy" className="w-full h-full object-cover transition-all duration-700 group-hover:scale-110 grayscale group-hover:grayscale-0" />
