...
export function FinalCTA() {
  ...
  return (
    <Section spacing="compact" background="dark" showGridLines>
      <Container>
        <motion.div
          ref={ref}
          ...
          className="relative text-center py-8 sm:py-12 md:py-16 px-4 sm:px-8 md:px-12 rounded-3xl border border-white/5 bg-carbon/20 backdrop-blur-sm overflow-hidden"
        >
