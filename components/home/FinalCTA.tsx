...
export function FinalCTA() {
 ...
 className="relative text-center py-10 sm:py-12 md:py-14 px-6 sm:px-10 md:px-16 border border-white/[0.06] bg-white/[0.02] overflow-hidden" >
 ...
 className="w-12 h-12 sm:w-16 sm:h-16 mx-auto mb-6 sm:mb-8 border-2 border-burgundy/40 flex items-center justify-center" >
 ...
 <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display mb-4 sm:mb-5 max-w-[24ch] mx-auto leading-tight">
 You don&apos;t need another agency. You need a performance partner.
 </h2>

 <p className="text-sm sm:text-base text-white/40 mb-8 sm:mb-10 max-w-[55ch] mx-auto leading-relaxed">
 ...
 <Link
 href="/contact" className="group relative inline-flex items-center justify-center px-8 sm:px-10 py-3.5 sm:py-4 bg-burgundy text-white text-sm font-bold uppercase tracking-wider overflow-hidden hover:shadow-[0_0_30px_rgba(109,0,26,0.25)] transition-all duration-300" >
 Book a Consultation
 ...
 <a
 href="https://wa.me/919999999999?text=Hi%2C%20I%27m%20interested%20in%20working%20with%20GT%20Media" target="_blank" rel="noopener noreferrer" className="inline-flex items-center justify-center px-8 sm:px-10 py-3.5 sm:py-4 border border-white/20 text-white/70 text-sm font-bold uppercase tracking-wider hover:border-white/40 hover:text-white transition-all duration-300 group" >
