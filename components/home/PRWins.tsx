...
export function PRWins() {
 ...
 className="absolute top-0 left-4 w-full h-64 bg-black border border-white/10 p-6 shadow-2xl transform origin-bottom-left z-10" >
 ...
 className="absolute top-12 left-0 w-full h-64 bg-gradient-to-br from-burgundy/20 to-black border border-burgundy/30 p-6 shadow-2xl backdrop-blur-sm z-20" >
 <div className="flex justify-between items-start mb-6">
 <div className="h-4 w-32 bg-burgundy opacity-80"/>
 <div className="px-2 py-1 bg-burgundy/20 text-[10px] text-burgundy uppercase tracking-wider">Confidential</div>
 </div>
 <div className="space-y-3 mb-6">
 <div className="h-3 w-full bg-white/10 animate-pulse"/>
 <div className="h-3 w-3/4 bg-white/10 animate-pulse delay-75"/>
 </div>
 ...
 <div className="p-5 bg-white/[0.03] border-l-2 border-burgundy mb-6">
 <p className="text-white italic">
"Results that speak louder than the NDAs that bind them." </p>
 </div>

 <Link
 href="/contact" className="inline-flex items-center gap-3 px-8 py-4 bg-white text-black font-medium hover:bg-burgundy hover:text-white transition-all duration-300" >
