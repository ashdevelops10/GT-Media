...
export function ResultsProof() {
 ...
 <div className="relative border border-black/8 p-5 sm:p-6 md:p-7 bg-white/30 hover:border-burgundy/30 hover:bg-white/50 transition-all duration-300 overflow-hidden h-full">
 {/* Icon */}
