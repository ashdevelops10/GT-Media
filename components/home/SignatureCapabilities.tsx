...
export function SignatureCapabilities() {
 ...
 <div className="relative border border-black/8 p-6 md:p-7 h-full flex flex-col hover:border-burgundy/40 transition-all duration-300 bg-white/40 group-hover:bg-white/60 group-hover:-translate-y-1 group-hover:shadow-lg overflow-hidden">
 ...
 <div className="w-7 h-7 border border-black/15 group-hover:border-burgundy group-hover:bg-burgundy/10 flex items-center justify-center transition-all duration-300">
