...
export function WhyChooseUs() {
 ...
 <div className="relative border border-white/[0.06] p-5 sm:p-6 h-full bg-white/[0.02] hover:border-burgundy/20 hover:bg-white/[0.04] transition-all duration-300 hover:translate-y-[-2px] overflow-hidden">
 {/* Background number */}
