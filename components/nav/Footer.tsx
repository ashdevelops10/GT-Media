...
export function Footer() {
 ...
 <Link
 href="/contact"className="group relative inline-flex items-center gap-2 px-6 py-3 border border-burgundy/50 text-burgundy text-xs font-accent font-bold uppercase tracking-wider overflow-hidden hover:text-white transition-colors duration-300" >
 ...
 <a
 href={link.href}
 target="_blank" rel="noopener noreferrer" className="text-sm text-white/40 hover:text-burgundy transition-colors duration-200 uppercase tracking-wide" >
 {link.label}
 </a>
 </li>
 ))}
