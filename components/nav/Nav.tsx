  ...
  return (
    <header className="fixed inset-x-0 top-0 z-nav border-b border-graphite-700/30 bg-onyx/70 backdrop-blur-md">
      <nav className="luxury-container flex items-center justify-between py-3 sm:py-4 px-4 sm:px-6 lg:px-8">
        <Link
          href="/"
          className="font-medium tracking-tight text-white transition-opacity duration-xs hover:opacity-70 text-lg sm:text-xl"
        >
          GT Media
        </Link>
        ...
        <button
          ...
          className="md:hidden text-white focus:outline-none focus:ring-2 focus:ring-orange focus:ring-offset-2 focus:ring-offset-onyx rounded-md min-w-[48px] min-h-[48px] flex items-center justify-center"
