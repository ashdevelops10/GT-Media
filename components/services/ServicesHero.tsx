...
export function ServicesHero() {
 ...
 <p className="text-xs sm:text-sm uppercase tracking-widest text-burgundy mb-4 sm:mb-6">
 ...
 <p className="text-base sm:text-lg md:text-xl text-white/50 max-w-[60ch] mx-auto leading-relaxed">
 ...
 <div className="group">
 <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 border border-burgundy/30 flex items-center justify-center group-hover:bg-burgundy/10 transition-colors duration-300">
 ...
 <p className="text-2xl sm:text-3xl md:text-4xl font-display text-burgundy mb-1 sm:mb-2">3.2×</p>
 <p className="text-xs sm:text-sm text-white/50">Avg ROAS Achieved</p>
 </div>
 <div className="group">
 <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 border border-burgundy/30 flex items-center justify-center group-hover:bg-burgundy/10 transition-colors duration-300">
 <svg className="w-5 h-5 sm:w-6 sm:h-6 text-burgundy"viewBox="0 0 24 24"fill="none"xmlns="http://www.w3.org/2000/svg">
 ...
 <p className="text-2xl sm:text-3xl md:text-4xl font-display text-burgundy mb-1 sm:mb-2">50+</p>
 <p className="text-xs sm:text-sm text-white/50">Clients Served</p>
 </div>
 <div className="group">
 <div className="w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 border border-burgundy/30 flex items-center justify-center group-hover:bg-burgundy/10 transition-colors duration-300">
 <svg className="w-5 h-5 sm:w-6 sm:h-6 text-burgundy"viewBox="0 0 24 24"fill="none"xmlns="http://www.w3.org/2000/svg">
 ...
 <p className="text-2xl sm:text-3xl md:text-4xl font-display text-burgundy mb-1 sm:mb-2">4</p>
 <p className="text-xs sm:text-sm text-white/50">Industry Verticals</p>
 </div>
 </div>
 </motion.div>
 </Container>
