...
export function BrandPortfolio() {
 ...
 label="All Brands" count={PORTFOLIO_ITEMS.length}
 />
 {BRANDS.map((brand) => (
 <BrandPill
 key={brand.id}
 ...
 className={`px-3 py-1.5 text-[10px] uppercase tracking-widest font-bold transition-all duration-200 ${
 activeType === t
 ?"bg-white/10 text-white" :"text-white/30 hover:text-white/50" }`}
 >
 ...
 className="mb-10 p-5 border border-white/[0.06] bg-white/[0.02] flex flex-col sm:flex-row items-start sm:items-center gap-4" >
 <div className="relative w-12 h-12 overflow-hidden bg-white flex-shrink-0">
 <Image
 ...
 <span className="text-[10px] uppercase tracking-widest text-white/30 px-2 py-0.5 bg-white/[0.04]">
 ...
 target="_blank" rel="noopener noreferrer" className="flex-shrink-0 flex items-center gap-1.5 px-4 py-2 border border-white/10 text-[10px] text-white/50 hover:text-white hover:border-white/20 transition-all duration-200 uppercase tracking-widest" >
...
function BrandPill({
 ...
 <button
 onClick={onClick}
 className={`group flex items-center gap-2 px-3.5 py-2 text-xs font-bold uppercase tracking-wider transition-all duration-200 border ${
 active
 ?"border-burgundy/40 bg-burgundy/10 text-burgundy" :"border-white/[0.06] text-white/40 hover:border-white/15 hover:text-white/60" }`}
 >
 {logo && (
 <div className="relative w-5 h-5 overflow-hidden bg-white flex-shrink-0">
 <Image
 src={logo}
 alt={label}
 fill
...
function PortfolioCard({
 ...
 className="group" >
 <div className="border border-white/[0.06] overflow-hidden bg-black hover:border-white/[0.12] transition-colors duration-300">
 {/* Instagram embed */}
 <InstagramEmbed
 poster={item.poster}
 video={item.video}
 ...
 <span
 className="text-[9px] uppercase tracking-widest px-2 py-0.5" style={{
