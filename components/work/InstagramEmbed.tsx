...
export function InstagramEmbed({
  ...
  return (
    ...
    >
      ...
      {/* Play icon + "Watch on Instagram" CTA */}
      <a
        href={instagramUrl}
        target="_blank"
        rel="noopener noreferrer"
        className="absolute inset-0 z-10 flex flex-col items-center justify-center gap-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
      >
        {/* Play circle */}
        {isReel && (
          <div
        ...
        <span className="text-[10px] uppercase tracking-widest font-bold text-white/80 px-3 py-1.5 bg-black/40 backdrop-blur-sm rounded-full">
      ...
      <div className="absolute bottom-3 right-3 z-10">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1.5 px-2.5 py-1 bg-black/50 backdrop-blur-sm rounded-full text-[10px] text-white/60 hover:text-white transition-colors duration-200"
        >
