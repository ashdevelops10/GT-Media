...
export default function LuxuryCursor() {
 ...
 return (
 <>
 <div ref={dotRef} className="fixed pointer-events-none z-[9999] w-[4px] h-[4px] rounded-full bg-burgundy -translate-x-1/2 -translate-y-1/2"/>
 <div ref={haloRef} className="fixed pointer-events-none z-[9998] w-[10px] h-[10px] rounded-full border border-burgundy -translate-x-1/2 -translate-y-1/2 mix-blend-screen"/>
 </>
 );
}
